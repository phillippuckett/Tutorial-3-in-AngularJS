angular.module('chatroom').service('parseService', function ($http) {
  ...
  // REST = A protocol for web requests, which stands for Representational State Transfer //
  ...
  this.getData = function () {
    return $http({
      ...
      console.log("this is the result from the server(in my service)", result);
      console.log("after we've drilled down", result.data.results);
